...
namespace smog_sw_ppc_model_namespace {
...
{" (found before start of program)",
 " (in '/home/projekt/DA_projectv1500/DA_project/smog_sw_ppc.stan', line 3, column 2 to column 33)",
 " (in '/home/projekt/DA_projectv1500/DA_project/smog_sw_ppc.stan', line 4, column 2 to column 36)",
 " (in '/home/projekt/DA_projectv1500/DA_project/smog_sw_ppc.stan', line 5, column 2 to column 34)",
 " (in '/home/projekt/DA_projectv1500/DA_project/smog_sw_ppc.stan', line 6, column 2 to column 32)",
 " (in '/home/projekt/DA_projectv1500/DA_project/smog_sw_ppc.stan', line 7, column 2 to column 32)",
 " (in '/home/projekt/DA_projectv1500/DA_project/smog_sw_ppc.stan', line 8, column 2 to column 31)",
 " (in '/home/projekt/DA_projectv1500/DA_project/smog_sw_ppc.stan', line 9, column 2 to column 42)",
 " (in '/home/projekt/DA_projectv1500/DA_project/smog_sw_ppc.stan', line 11, column 2 to column 38)",
 " (in '/home/projekt/DA_projectv1500/DA_project/smog_sw_ppc.stan', line 12, column 2 to column 57)",
 " (in '/home/projekt/DA_projectv1500/DA_project/smog_sw_ppc.stan', line 13, column 2 to column 60)",
 " (in '/home/projekt/DA_projectv1500/DA_project/smog_sw_ppc.stan', line 14, column 2 to column 54)",
 " (in '/home/projekt/DA_projectv1500/DA_project/smog_sw_ppc.stan', line 16, column 2 to column 32)",
 " (in '/home/projekt/DA_projectv1500/DA_project/smog_sw_ppc.stan', line 18, column 2 to column 121)",
 " (in '/home/projekt/DA_projectv1500/DA_project/smog_sw_ppc.stan', line 19, column 2 to column 38)"};




class smog_sw_ppc_model final : public model_base_crtp<smog_sw_ppc_model> {
 ...
 public:
  ...
  inline std::string model_name() const final { return "smog_sw_ppc_model"; }
  ...
  smog_sw_ppc_model(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ = "smog_sw_ppc_model_namespace::smog_sw_ppc_model";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "smog_sw_ppc_model_namespace::log_prob";
    (void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "smog_sw_ppc_model_namespace::write_array";
    (void) function__;  // suppress unused var warning
    ...
    try {
      ...
      alpha = stan::math::normal_rng(25, 2, base_rng__);
      ...
      d_pp = stan::math::normal_rng(-6, 1, base_rng__);
      double d_hs = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 5;
      d_hs = stan::math::normal_rng(11, 1, base_rng__);
      double d_wn = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 6;
      d_wn = stan::math::normal_rng(2, 2, base_rng__);
      double sigma = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 7;
      sigma = stan::math::normal_rng(20, 1, base_rng__);
...
using stan_model = smog_sw_ppc_model_namespace::smog_sw_ppc_model;
...
stan::math::profile_map& get_stan_profile_data() {
  return smog_sw_ppc_model_namespace::profiles__;
}
